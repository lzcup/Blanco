...
VULKAN_SDK_INSTALLER_URL = 'https://sdk.lunarg.com/sdk/download/1.3.283.0/windows/VulkanSDK-1.3.283.0-Installer.exe'
BLANCO_VULKAN_VERSION = '1.3.283.0'
VULKAN_SDK_EXE_PATH = 'Blanco/vendor/VulkanSDK/VulkanSDK.exe'
...
def CheckVulkanSDK():
    if (VULKAN_SDK is None):
        ...
        InstallVulkanPrompt()
        return False
    elif (BLANCO_VULKAN_VERSION not in VULKAN_SDK):
        print(f"Located Vulkan SDK at {VULKAN_SDK}")
        print(f"You don't have the correct Vulkan SDK version! (Blanco requires {BLANCO_VULKAN_VERSION})")
        InstallVulkanPrompt()
        return False
...
OutputDirectory = "Blanco/vendor/VulkanSDK"
